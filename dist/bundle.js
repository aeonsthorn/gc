...
function create(name, options) {
  return __async(this, null, function* () {
    ...
    const componentFile = yield import_fs.promises.readFile(path.join(process.cwd(), "template/typescript/__Component__.tsx"), { encoding: "utf-8" });
    yield import_fs.promises.writeFile(path.join(process.cwd(), name, `${componentName}.tsx`), componentFile.replace(/__Component__/g, componentName));
  });
}
...
program2.name("GC").description("Generate components and related utils").version("0.0.1");
program2.command("create").description("Create a new component").argument("<name>", "Name for the component").option("--dry-run", "Dry run").option("--js", "Javascript version").action(create_default);
program2.command("rename").description("Rename a component").argument("<oldName>", "Name for the component").argument("<newName>", "New name for the component").action((oldName, newName, options) => {
  console.log({ oldName });
  console.log({ newName });
});
program2.command("delete").description("Delete a component").argument("<name>", "Name for the component").action((name, options) => {
  console.log({ name });
});
